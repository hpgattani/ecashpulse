...
// Correct RIPEMD160 implementation (matches send-payouts and create-prediction-escrow)
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    for (const pred of predictions || []) {
      ...
      const correctAddress = hash160ToCashAddr(pubkeyHash);
      const correctScriptHex = '76a914' + toHex(pubkeyHash) + '88ac';
