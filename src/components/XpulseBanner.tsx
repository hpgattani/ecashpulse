  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ height: 'auto' }}
        exit={{ height: 0 }}
        className="fixed left-0 right-0 z-50 bg-[hsl(160,80%,40%)] text-white overflow-hidden top-[calc(var(--security-banner-height,0px)+4rem)] md:top-[calc(var(--security-banner-height,0px)+5rem)]"
      >
